...
import { cn } from '@/lib/utils/clsx-merge'
  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-side={side}
        className={cn(
          'fixed inset-y-0 z-10 hidden border-border/20 h-full w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear data-[side=left]:left-0 data-[side=left]:group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)] data-[side=right]:right-0 data-[side=right]:group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)] md:flex',
...
function SidebarRail({ className, ...props }: React.ComponentProps<'button'>) {
  ...
  return (
    <button
      ...
      className={cn(
        'hover:after:bg-border/50 after:transition-colors absolute inset-y-0 z-20 hidden w-4 transition-all ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:inset-s-1/2 after:w-0.5 sm:flex ltr:-translate-x-1/2 rtl:-translate-x-1/2',
...
function SidebarInset({ className, ...props }: React.ComponentProps<'main'>) {
  return (
    <main
      ...
      className={cn(
        'bg-background relative flex h-full w-full flex-1 flex-col',
        className,
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  'ring-sidebar-ring hover:bg-sidebar-primary-foreground hover:text-sidebar-accent-foreground active:bg-sidebar-primary-foreground active:text-sidebar-accent-foreground data-active:bg-sidebar-primary-foreground data-active:text-sidebar-accent-foreground data-open:hover:bg-sidebar-primary-foreground data-open:hover:text-sidebar-accent-foreground gap-2 rounded-md p-2 text-start text-sm transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pe-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! focus-visible:ring-2 data-active:font-medium peer/menu-button flex w-full items-center overflow-hidden outline-hidden group/menu-button disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
          'hover:bg-sidebar-primary-foreground hover:text-sidebar-accent-foreground',
        muted:
          'text-muted-foreground hover:bg-secondary hover:text-foreground dark:hover:bg-muted/50 aria-expanded:bg-secondary dark:aria-expanded:bg-muted/50 aria-expanded:text-foreground',
        outline:
