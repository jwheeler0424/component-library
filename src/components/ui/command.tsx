...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent
        className={cn(
          'top-1/3 -translate-y-1/3 overflow-hidden rounded-xl! p-0',
          className,
        )}
...
function CommandInputDebounced({ className, ...props }: InputDebouncedProps) {
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup className="bg-input/30 border-input/30 h-8! rounded-lg! shadow-none! *:data-[slot=input-group-addon]:ps-2!">
        <InputGroupInputDebounced
...
function CommandList({
  ...
  return (
    <CommandPrimitive.List
      ...
      className={cn(
        'no-scrollbar max-h-74 scroll-py-1 overflow-x-hidden overflow-y-auto outline-none',
        className,
      )}
      {...props}
    />
