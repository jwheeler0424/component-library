...
function InputGroupInput({ className, ...props }: React.ComponentProps<'input'>) {
  return (
    <Input
      ...
      className={cn(
        'flex-1 rounded-none border-0 bg-transparent shadow-none ring-0 autofill:border-0 autofill:bg-transparent focus-visible:ring-0 aria-invalid:ring-0 dark:bg-transparent',
        className,
      )}
      {...props}
    />
...
function InputGroupInputDebounced({ className, ...props }: InputDebouncedProps) {
  return (
    <InputDebounced
      data-slot="input-group-control"
      className={cn(
...
function InputGroupTextareaDebounced({ className, ...props }: TextareaDebouncedProps) {
  return (
    <TextareaDebounced
      data-slot="input-group-control"
      className={cn(
