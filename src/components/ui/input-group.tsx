...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      className={cn(
        'rounded-none autofill:border-0 border-0 autofill:bg-transparent bg-transparent shadow-none ring-0 focus-visible:ring-0 aria-invalid:ring-0 dark:bg-transparent flex-1',
        className,
      )}
      {...props}
    />
...
function InputGroupInputDebounced({
  className,
  ...props
}: InputDebouncedProps) {
  return (
...
function InputGroupTextareaDebounced({
  className,
  ...props
