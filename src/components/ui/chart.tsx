    ...
    <ChartContext.Provider value={{ config }}>
      ...
      >
        ...
        <RechartsPrimitive.ResponsiveContainer
          initialDimension={initialDimension || { width: 16, height: 9 }}
          aspect={aspect}
        >
          {children}
        </RechartsPrimitive.ResponsiveContainer>
...
function ChartTooltipContent({
  ...
  Partial<Pick<TooltipContentProps, 'payload' | 'label'>> &
  React.ComponentProps<'div'> & {
    hideLabel?: boolean
        ...
        {payload
          ...
          .map((item, index) => {
            ...
            return (
              <div
                key={
                  (item.dataKey as string | number | undefined) ||
                  `label-${index}`
                }
                className={cn(
